						...
						case IRCMD_REFILL_GUN_AMMO:	// 2 bytes (id hi, val low)
							{
								...
								//if(current_state == STATE_ADMIN){digitdraw(88); my_delay(500);};
								if ( current_state & (STATE_GAME | STATE_OUT ) )
								{
