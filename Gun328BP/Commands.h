...
#define IRCMD_SHIELD_ENERGY		IRCMD_HEADER+1	// Information to Gun : Playr, Energy
#define IRCMD_STOG_INFO			IRCMD_HEADER+2	// Information to Gun : Gun activate, Timeout
...
#define IRCMD_INVULNERABLE		IRCMD_HEADER+14	// Sedn heart to gun
